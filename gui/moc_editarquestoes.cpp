...
void EditarQuestoes::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<EditarQuestoes *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject EditarQuestoes::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_EditarQuestoes.data,
    qt_meta_data_EditarQuestoes,
    qt_static_metacall,
    nullptr,
    nullptr
} };
